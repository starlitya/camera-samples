package com.android.example.cameraxbasic.opengl
...
class Renderer : SurfaceTexture.OnFrameAvailableListener {
    ...
    private var mFilterEngine: TextureShader? = null
    ...
    private fun initEGL() {
        ...
        mFilterEngine = TextureShader(mOESTextureId)
